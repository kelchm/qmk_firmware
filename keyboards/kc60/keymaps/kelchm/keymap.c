...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	* |-----------------------------------------------------------|
	* |Ctrl|Alt |Gui |      SpaceFN          |Alt |FN  |Gui |Ctrl |
	* `-----------------------------------------------------------'
	*/
  [0] = KEYMAP( 
      ...
      KC_LCTL,  KC_LALT,  KC_LGUI,                      KC_FN0,                                           KC_RALT,  TG(1),    KC_RGUI,  KC_RCTL    \
      ),

   /* Basic QWERTY (Windows)
	* ,-----------------------------------------------------------.
	* |Esc | 1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|Backsp |
	* |-----------------------------------------------------------|
	* |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|  \  |
  ...
  [1] = KEYMAP( 
      ...
      KC_LSFT,  KC_NO,    KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_NO,    KC_RSFT,   \
      KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_FN0,                                           KC_RALT,  KC_TRNS,  KC_RGUI,  KC_RCTL    \
      ),
  ...
  [2] = KEYMAP( /* Function Layer */
      ...
      RESET,    KC_TRNS,  KC_TRNS,                      KC_FN0,                                          KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS    \
      ),
};
